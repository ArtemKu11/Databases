package ru.kuchumov.pstuDatabases.tasks.secondTask.sqlUtils;

import ru.kuchumov.pstuDatabases.databaseUtils.sqlUtils.TypicalSqlUtils;
import ru.kuchumov.pstuDatabases.databaseUtils.sqlUtils.UsualPrintable;

import java.util.List;

public class SecondTaskSqlUtils extends UsualPrintable implements TypicalSqlUtils {
    @Override
